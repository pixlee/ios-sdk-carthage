...
@property (nonatomic) BOOL flagDeniedPhotos;
@property (nonatomic) BOOL flagStarredPhotos;
@property (nonatomic) BOOL flagDeletedPhotos;
@property (nonatomic) BOOL flagFlaggedPhotos;
@property (nonatomic) BOOL flagHasPermission;
@property (nonatomic) BOOL flagHasProduct;
@property (nonatomic) BOOL flagInStockOnly;
@property (nonatomic) BOOL flagHasActionLink;
